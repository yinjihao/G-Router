package com.example.mysterious.router.util;
...
public class PriorityList<T> extends AbstractList<T> {
    ...
    public boolean addItem(T item, int priority) {
        ...
        ListIterator<Node<T>> nodeListIterator = mList.listIterator();
        while (nodeListIterator.hasNext()) {
            Node<T> next = nodeListIterator.next();
    ...
    private class NodeIterator implements Iterator<T> {
        private final ListIterator<PriorityList.Node<T>> mIterator;
